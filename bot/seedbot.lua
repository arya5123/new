...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {147368581,110113114,138583448,114900277},--Sudo users
    disabled_channels = {},
...
حذف کردن کمک مدیر
—-------------------
!lock adds/bot/name/tag/badw
قفل [اعضا|نام|ربات |تگ|عکس|خروج|فحش]
—----------------------
!unlock adds/bot/name/tag/badw
...
Writed by BOSS Team
Developer:@elyasgalikeshi
Sudo:hack9999
Admin:@aliraygan
@xxx_bokon_namoos_xxxxxx
